...
class MmsReceivedVideoTest : TestFlow() {
    ...
    override fun onCreateScript(): List<Action> {
        ...
        actions.add(Action.ClickListItem(Selector.ByCls("android.support.v7.widget.RecyclerView"),0,"android.widget.RelativeLayout","070110 46214",stepName ="Chat Window open", testFalg = UtilsClass.ReceivedVidio_MMS))

        actions.add(Action.Delay(1))

        actions.add(Action.ClickListItemByIndex(Selector.ByCls("android.support.v7.widget.RecyclerView"),0,"com.google.android.apps.messaging:id/conversation_message_view",6,stepName ="Select Last Message", testFalg = UtilsClass.ReceivedVidio_MMS))
